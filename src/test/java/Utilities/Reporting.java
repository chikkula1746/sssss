...
public class Reporting implements ITestListener{
	...
	public void onStart(ITestContext testcontext) {
		//create time stamp
		String timestamp=new SimpleDateFormat("yyyy.MM.dd.mm.ss").format(new Date(0));
		//create report name
		String repName="reports-test" + timestamp + ".html";
	    ...
	    extent.setSystemInfo("user", "Virat");
	...
	public void onTestFailure(ITestResult tr) {
		...
		String screenshotPath=System.getProperty("user.dir")+"/Screenshots02/"+tr.getName()+".png";
